...
then
    ...
    then
        ...
        find / -path /proc -prune -group $SC_USER_ID -exec chgrp -h $GROUPNAME {} \;
    else
...
exec su --preserve-environment --command "export PATH=${PATH}:/home/$SC_USER_NAME/service.cli; $@" "$SC_USER_NAME"
